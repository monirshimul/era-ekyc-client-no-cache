...
import {convertIso} from '../../Simplified/utils/DateFormat';
import { NotificationManager } from "react-notifications";

export class PersonalDetails extends Component {
    state = {
        applicantName:JSON.parse(localStorage.getItem('NidImages')) ? JSON.parse(localStorage.getItem('NidImages')).OcrData["Name English"] : "",
        applicantNameBangla:JSON.parse(localStorage.getItem('NidImages'))? JSON.parse(localStorage.getItem('NidImages')).OcrData["Name Bangla"]: '',
        applicantDob:JSON.parse(localStorage.getItem('NidImages')) ? JSON.parse(localStorage.getItem('NidImages')).OcrData.DOB: '',
        applicantDobDate: '',
        applicantNidNo:JSON.parse(localStorage.getItem('NidImages')) ? JSON.parse(localStorage.getItem('NidImages')).OcrData.id: '',
        motherName: '',
        motherNameBangla:JSON.parse(localStorage.getItem('NidImages')) ? JSON.parse(localStorage.getItem('NidImages')).OcrData.Mother: '',
        fatherName: '',
        fatherNameBangla:JSON.parse(localStorage.getItem('NidImages')) ? JSON.parse(localStorage.getItem('NidImages')).OcrData.Father: '',
        spouseName: '',
        gender: '',
        profession: '',
        mobileNumber: '',
        presentAddress: '',
        permanentAddress: '',
        permanentAddressBangla:JSON.parse(localStorage.getItem('NidImages')) ? JSON.parse(localStorage.getItem('NidImages')).OcrData.Address : '',
        monthlyIncome:'',
        sourceOfFund: '',
        nationality: '',
        tin: ''
    ...
    continue = e => {
        let { applicantName,applicantNameBangla, applicantDob,applicantDobDate, applicantNidNo, motherName,motherNameBangla, fatherName,fatherNameBangla, spouseName, gender, profession, mobileNumber, presentAddress, permanentAddress,permanentAddressBangla, monthlyIncome, sourceOfFund,nationality,tin } = this.state;
        e.preventDefault();
        ...
        // }
         ...
         // if(monthlyIncome === ''){
        //     let monthlyIncomeMessage = "Please Provide Your Monthly Income";
        //     NotificationManager.warning(monthlyIncomeMessage, "Warning", 5000);
        //     return;
        // }
        ...
        // }
          ...
          // if(sourceOfFund === ''){
        //     let sourceOfFundMessage = "Please Provide Your Source of Fund";
        //     NotificationManager.warning(sourceOfFundMessage, "Warning", 5000);
        //     return;
        // }

          // if(nationality === ''){
        //     let nationalityMessage = "Please Provide Your Nationality";
        //     NotificationManager.warning(nationalityMessage, "Warning", 5000);
        //     return;
        // }
        ...
        const personal = {
            ...
            applicantNameBangla,
            applicantDob,
            applicantDobDate:applicantDob ? new Date(applicantDob).toISOString(): "",
            applicantNidNo,
            motherName,
            motherNameBangla,
            fatherName,
        ...
        this.props.history.push('/dashboard/regular-nominee');
    };
    ...
    back = e => {
        ...
        if (nextRoute.type === "FACE") {
          ...
          this.props.history.push('/dashboard/regular-captureface');
        } else {
          this.props.history.push('/dashboard/regular-fingerprint');
        }

    }

    render() {
        let { applicantName,applicantNameBangla, applicantDob, applicantNidNo, motherName, motherNameBangla, fatherName,fatherNameBangla, spouseName, gender, profession, mobileNumber, presentAddress, permanentAddress,permanentAddressBangla, monthlyIncome, sourceOfFund,nationality,tin } = this.state;
                    ...
                    <form className="row d-flex justify-content-around" >
                        ...
                        <div className="col-sm-4 imTwo">
                            ...
                            <div className="form-group ">
                                ...
                                <input style={{ borderRadius: "50px" }} type="text" value={monthlyIncome} name="monthlyIncome" onChange={this.onChange} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Monthly Income" />
                                ...
                                <input style={{ borderRadius: "50px" }} type="text" value={sourceOfFund} name="sourceOfFund" onChange={this.onChange} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Provide Source of Fund" />
                                ...
                                <input style={{ borderRadius: "50px" }} type="text" value={nationality} name="nationality" onChange={this.onChange} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Provide Nationality" />
                                ...
                                <input style={{ borderRadius: "50px" }} type="text" value={tin} name="tin" onChange={this.onChange} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Provide Tin No" />
