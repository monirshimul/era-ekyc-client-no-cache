...
import Account from '../../Simplified/Account';
...
export class ConfirmInfo extends Component {
    ...
    continue = async (e) => {
        ...
        //         localStorage.clear();
        //         this.props.history.replace('/dashboard/regular-complete');
                    ...
                    <div class="row card-body d-flex justify-content-around">
                        ...
                        <div className="col-sm-5 animated zoomIn" style={{ margin: "20px 0px" }}>
                            ...
                            <div className="">
                                ...
                                <p className="text-muted">Monthly Income : {personalDetailsData.monthlyIncome}</p>
                                <p className="text-muted">Source of Fund : {personalDetailsData.sourceOfFund}</p>
                                <p className="text-muted">Nationality : {personalDetailsData.nationality}</p>
                                <p className="text-muted">Tin No : {personalDetailsData.tin}</p>
