...
export class FullChannelData extends Component {
    state = {
        ekyc: null,
        ProductCodetoName: '',
    ...
    async componentDidMount() {
        ...
        this.setState({prevObj: this.props.location.state});
    ...
    backEkyc = () => {
        ...
        // this.props.history.goBack(prevObj);
        this.props.history.push('/dashboard/channel-search', this.state.prevObj);
    }
...
export default FullChannelData;
