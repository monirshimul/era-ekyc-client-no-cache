...
export class Confirm extends Component {
  ...
  continue = async (e) => {
    ...
    if (values.applicantEkycId === "") {
      let branchOrAgentPointCode = JSON.parse(
        sessionStorage.getItem("currentBranchOrAgentPointCode")
      );
      ...
      if (values.spouseName !== "")
        applicantInfo.spouseName = values.spouseName;
      ...
      if (values.preAdditionalMouzaOrMoholla !== "")
        applicantPresentInfo.additionalMouzaOrMoholla = values.preAdditionalMouzaOrMoholla.toString();
      if (values.preAdditionalVillageOrRoad !== "")
        applicantPresentInfo.additionalVillageOrRoad = values.preAdditionalVillageOrRoad.toString();
      if (values.preCityCorporationOrMunicipality !== "")
        applicantPresentInfo.cityCorporationOrMunicipality = values.preCityCorporationOrMunicipality.toString();
      if (values.preDistrictCode !== "")
        applicantPresentInfo.districtCode = values.preDistrictCode.toString();
      if (values.preUpozilaCode !== "")
        applicantPresentInfo.upozilaCode = values.preUpozilaCode.toString();
      if (values.preUnionOrWardCode !== "")
        applicantPresentInfo.unionCode = values.preUnionOrWardCode.toString();
      if (values.preDivision !== "")
        applicantPresentInfo.division = values.preDivision.toString();
      if (values.preHomeOrHoldingNo !== "")
        applicantPresentInfo.homeOrHoldingNo = values.preHomeOrHoldingNo.toString();
      if (values.prePostOffice !== "")
        applicantPresentInfo.postOffice = values.prePostOffice.toString();
      if (values.preRegion !== "")
        applicantPresentInfo.region = values.preRegion.toString();
      if (values.prePostalCode !== "")
        applicantPresentInfo.postalCode = values.prePostalCode.toString();
      if (values.preRmo !== "")
        applicantPresentInfo.rmo = values.preRmo.toString();
      if (values.preWardForUnionPorishod !== "")
        applicantPresentInfo.wardForUnionPorishod = values.preWardForUnionPorishod.toString();
      if (values.preAdditionalMouzaOrMohollaEn !== "")
        applicantPresentInfo.additionalMouzaOrMohollaEng = values.preAdditionalMouzaOrMohollaEn.toString();
      if (values.preAdditionalVillageOrRoadEn !== "")
        applicantPresentInfo.additionalVillageOrRoadEng = values.preAdditionalVillageOrRoadEn.toString();
      if (values.preCityCorporationOrMunicipalityEn !== "")
        applicantPresentInfo.cityCorporationOrMunicipalityEng = values.preCityCorporationOrMunicipalityEn.toString();
      if (values.preDivisionEn !== "")
        applicantPresentInfo.divisionEng = values.preDivisionEn.toString();
      if (values.preHomeOrHoldingNoEn !== "")
        applicantPresentInfo.homeOrHoldingNoEng = values.preHomeOrHoldingNoEn.toString();
      if (values.prePostOfficeEn !== "")
        applicantPresentInfo.postOfficeEng = values.prePostOfficeEn.toString();
      if (values.preRegionEn !== "")
        applicantPresentInfo.regionEng = values.preRegionEn.toString();
      ...
      if (values.perAdditionalMouzaOrMoholla !== "")
        applicantPermanentInfo.additionalMouzaOrMoholla = values.perAdditionalMouzaOrMoholla.toString();
      if (values.perAdditionalVillageOrRoad !== "")
        applicantPermanentInfo.additionalVillageOrRoad = values.perAdditionalVillageOrRoad.toString();
      if (values.perCityCorporationOrMunicipality !== "")
        applicantPermanentInfo.cityCorporationOrMunicipality = values.perCityCorporationOrMunicipality.toString();
      if (values.perDistrictCode !== "")
        applicantPermanentInfo.districtCode = values.perDistrictCode.toString();
      if (values.perUpozilaCode !== "")
        applicantPermanentInfo.upozilaCode = values.perUpozilaCode.toString();
      if (values.perUnionOrWardCode !== "")
        applicantPermanentInfo.unionCode = values.perUnionOrWardCode.toString();
      if (values.perDivision !== "")
        applicantPermanentInfo.division = values.perDivision.toString();
      if (values.perHomeOrHoldingNo !== "")
        applicantPermanentInfo.homeOrHoldingNo = values.perHomeOrHoldingNo.toString();
      if (values.perPostOffice !== "")
        applicantPermanentInfo.postOffice = values.perPostOffice.toString();
      if (values.perRegion !== "")
        applicantPermanentInfo.region = values.perRegion.toString();
      if (values.perPostalCode !== "")
        applicantPermanentInfo.postalCode = values.perPostalCode.toString();
      if (values.perRmo !== "")
        applicantPermanentInfo.rmo = values.perRmo.toString();
      if (values.perWardForUnionPorishod !== "")
        applicantPermanentInfo.wardForUnionPorishod = values.perWardForUnionPorishod.toString();
      if (values.perAdditionalMouzaOrMohollaEn !== "")
        applicantPermanentInfo.additionalMouzaOrMohollaEng = values.perAdditionalMouzaOrMohollaEn.toString();
      if (values.perAdditionalVillageOrRoadEn !== "")
        applicantPermanentInfo.additionalVillageOrRoadEng = values.perAdditionalVillageOrRoadEn.toString();
      if (values.perCityCorporationOrMunicipalityEn !== "")
        applicantPermanentInfo.cityCorporationOrMunicipalityEng = values.perCityCorporationOrMunicipalityEn.toString();
      if (values.perDivisionEn !== "")
        applicantPermanentInfo.divisionEng = values.perDivisionEn.toString();
      if (values.perHomeOrHoldingNoEn !== "")
        applicantPermanentInfo.homeOrHoldingNoEng = values.perHomeOrHoldingNoEn.toString();
      if (values.perPostOfficeEn !== "")
        applicantPermanentInfo.postOfficeEng = values.perPostOfficeEn.toString();
      if (values.perRegionEn !== "")
        applicantPermanentInfo.regionEng = values.perRegionEn.toString();
      ...
      try {
        ...
        let responseFirst = await axios.post(
          simplifiedJointAPI,
          confirmObj,
          config
        );
      ...
      try {
        this.props.handleState("confirmFlag", true);
        let resJointAdded = await axios.post(
          simplifiedJointAddAPI,
          confirmObjSecond,
          config
        );
        this.props.handleState("confirmFlag", false);
        ...
        <div className="card col-sm-12" style={{ paddingTop: "25px" }}>
            ...
            <div className="col-sm-6 " style={{ margin: "20px 0px" }}>
              ...
              <div className="">
                <small className="" style={{ fontSize: "14px" }}>
                  ...
                  {AccountType(values.accountType)},<br />
                  <span style={{ color: "green", fontSize: "14px" }}>
                    Product and Services :
                  </span>{" "}
                  {ProductCategoryType(values.product)},<br />
                  <span style={{ color: "green", fontSize: "14px" }}>
                    channel Name :
                  </span>{" "}
                  {values.channelName},<br />
                  <span style={{ color: "green", fontSize: "14px" }}>
                    Product Name :
                  </span>{" "}
                  {`${values.productName} (${this.state.ProductCodetoName})`},
                  <br />
                  <span style={{ color: "green", fontSize: "14px" }}>
                    Transaction Amount :
                  </span>{" "}
                  {values.transactionOrMaturityAmount},<br />
                </small>
            ...
            <div className="col-sm-6 " style={{ margin: "20px 0px" }}>
              ...
              <div className="">
                <small className="" style={{ fontSize: "14px" }}>
                  ...
                  {values.applicantNameBangla}
                  <br />
                  <span style={{ color: "green", fontSize: "14px" }}>
                    Applicant's DOB :
                  </span>{" "}
                  {dayMonthYearFormat(values.applicantDob)}
                  <br />
                  <span style={{ color: "green", fontSize: "14px" }}>
                    Mother's Name :
                  </span>{" "}
                  ...
                  {JointOperatorType(values.operatorType)}
                  <br />
                </small>
              </div>
            </div>
                ...
                acBody={
                  <div className="imTwoWhite">
                    <small className="" style={{ fontSize: "14px" }}>
                      ...
                      {values.perRmo +
                        `${values.perRmoEn ? `(${values.perRmoEn})` : ""}`}
                      <br />
                      <span style={{ color: "green", fontSize: "14px" }}>
                        Union Or Ward :
                      </span>{" "}
                ...
                acBody={
                  <div className="imTwoWhite">
                    <small className="" style={{ fontSize: "14px" }}>
                      ...
                      {values.preRmo +
                        `${values.preRmoEn ? `(${values.preRmoEn})` : ""}`}
                      <br />
                      <span style={{ color: "green", fontSize: "14px" }}>
                        Union Or Ward :
                      </span>{" "}
          ...
          <div className="row d-flex justify-content-center">
            <div className="imTwo text-center col-sm-3">
              ...
              <img
                src={values.NidFront ? values.flag + values.NidFront : front}
                alt=""
                style={{
                  margin: "0 auto",
                  width: "250px",
            ...
            <div className="imTwo text-center col-sm-3">
              ...
              <img
                src={values.NidBack ? values.flag + values.NidBack : back}
                alt=""
                style={{
                  margin: "0 auto",
                  width: "250px",
            ...
            <div className="imTwo text-center col-sm-3">
              ...
              <img
                src={values.faceImage ? values.flag + values.faceImage : Avater}
                alt=""
                style={{
                  margin: "0 auto",
                  width: "250px",
              ...
              {values.jointArray.map((val, i) =>
                val.isShow === true ? (
                  <div className="imTwo text-center col-sm-3">
                    ...
                    <img
                      src={
                        val.photograph ? values.flag + val.photograph : adult
                      }
                      alt=""
                      style={{
                        margin: "0 auto",
